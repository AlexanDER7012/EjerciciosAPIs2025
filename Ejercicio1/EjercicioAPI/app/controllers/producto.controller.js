    ...
    Producto.update(req.body, {
        ...
        .then(num => {
            if (num == 1) {
                ...
                res.send({
                    message: `Cannot update Producto with id=${id}. Maybe Client was not found or req.body is empty!`
                });
            }
        })
        .catch(err => {
    ...
    Producto.destroy({
        ...
        .then(num => {
            if (num == 1) {
                ...
                res.send({
                    message: `Cannot delete Producto with id=${id}. El cliente no fue encontado!`
                });
            }
        })
        .catch(err => {
